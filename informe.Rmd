...
Para poder entender los datos, que se pueden encontrar [acá](https://www.dropbox.com/s/6j24lrbqkqpiubs/Censo%202017%20-%20INE-20220503T151501Z-001.zip?dl=0), se procede a graficar la Novena Región del país, también conocida como la región de la Araucanía, y poder graficar la comuna de Temuco (vista en color verde) que se puede ver en el gráfico \@ref(fig:grafarau).
